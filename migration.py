...
class DataTransfer():
    ...
    def migrate_data(self, csv_path):
        ...
        try:
            ...
            logging.error(f"Error reading input table: {str(e)}")
            return
        ...
        try:
            ...
            logging.info(f"No Traget table found")
            ...
            logging.error(f"There is some error while performing transformation: {str(e)}")
            return
        ...
        try:
            ...
            logging.error(f"Failed to update target table: {str(e)}")
            return
